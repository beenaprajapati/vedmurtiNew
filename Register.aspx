<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/Main_Master.master" CodeFile="Register.aspx.cs" Inherits="Register" %>
                ...
                <div class="col-sm-offset-2 col-sm-8 col-md-offset-3 col-md-6">
                    ...
                    <div class="form-fields login-bg">
                        ...
                        <div class="form-group">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" ErrorMessage="Enter Password" ControlToValidate="txtpassword" ForeColor="Red" ValidationGroup="a"></asp:RequiredFieldValidator>
                                <asp:RegularExpressionValidator ID="RegExp1" runat="server"
                                    ErrorMessage="Password length must be 6  characters"
                                    ControlToValidate="txtpassword" ValidationGroup="a"
                            ...
                            <div class="form-group">
                                ...
                                <asp:CompareValidator ID="cmppassword" runat="server" ControlToValidate="txtconfpassword" ControlToCompare="txtpassword" ErrorMessage="Password not match" ForeColor="Red" ValidationGroup="a"></asp:CompareValidator>
                         ...
                         <div class="form-group">
                            ...
                            <asp:DropDownList ID="ddlrole" runat="server" CssClass="form-control">
                                ...
                                <asp:ListItem Text="State" Value="1">State</asp:ListItem>
                                <asp:ListItem Text="District" Value="2">District</asp:ListItem>
                            </asp:DropDownList>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator13" InitialValue="0" runat="server" ControlToValidate="ddlrole" ErrorMessage="Select Role" ForeColor="Red" ValidationGroup="a"></asp:RequiredFieldValidator>
