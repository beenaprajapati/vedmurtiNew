<%@ Page Title="" Language="C#" MasterPageFile="~/Main_Master.master" AutoEventWireup="true" CodeFile="EditProfile.aspx.cs" Inherits="EditProfile" %>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-sm-offset-2 col-sm-8 col-md-offset-3 col-md-6">
                    <h3><span id="ContentPlaceHolder1_pagename" runat="server">Edit Profile</span></h3>
                    <div class="title">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <asp:RegularExpressionValidator
                                ...
                                ControlToValidate="adharfile" ValidationGroup="a" ForeColor="Red" style="float:left;"></asp:RegularExpressionValidator>
                            <asp:Label ID="lbladhar" runat="server" ForeColor="Red" style="float:left;"></asp:Label>
                            <asp:HiddenField ID="hd1" runat="server" />
                            <asp:HiddenField ID="hdpan" runat="server" />
                                 </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="file">
                                ...
                                <asp:Label ID="lblpan" runat="server" ForeColor="Red" style="float:left;"></asp:Label>
                    ...
                    <div class="buttons">
                        <asp:Button ID="btnupdate" runat="server" class="btn-details" OnClick="btnupdate_Click" Text="Update" ValidationGroup="a" />
                    </div>
    ...
    <script type="text/javascript">
        function UploadFile(fileUpload) {
            if (fileUpload.value != '') {
                ...
                if (fileUpload.value && (ext == "jpeg" || ext == "jpg")) {
                    document.getElementById('<%=lbladhar.ClientID%>').style.visibility = "visible";
                    var files = document.getElementById('<%=adharfile.ClientID %>').files;
                    var fileData = new FormData();
                    document.getElementById('<%=lbladhar.ClientID%>').innerHTML = files[0].name;
                    $('#ContentPlaceHolder1_hdpan').val(files[0].name);
                    ...
                    var lbladhar = $('#lbladhar');
                    lbladhar.css('display', 'none');
                    document.getElementById('<%=lbladhar.ClientID%>').style.visibility = "hidden";
                }
        ...
        function UploadPan(fileUpload) {
            if (fileUpload.value != '') {
                var ext = fileUpload.value.substring(fileUpload.value.lastIndexOf('.') + 1).toLowerCase();
                if (fileUpload.value && (ext == "jpeg" || ext == "jpg")) {
                    document.getElementById('<%=lblpan.ClientID%>').style.visibility = "visible";
                    var files = document.getElementById('<%=panfilename.ClientID %>').files;

                    document.getElementById('<%=lblpan.ClientID%>').innerHTML = files[0].name;
                    $('#ContentPlaceHolder1_hd1').val(files[0].name);
                    ...
                    var lbladhar = $('#lblpan');
                    lbladhar.css('display', 'none');
                    document.getElementById('<%=lblpan.ClientID%>').style.visibility = "hidden";
                }
